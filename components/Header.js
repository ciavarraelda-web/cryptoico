    ...
    <header className="bg-white shadow-md">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white py-2 px-4 shadow-lg">
          ...
          <Link href="/icos" className="block py-2 text-gray-700 hover:text-green-600">ICO Listings</Link>
          <Link href="#" className="block py-2 text-gray-700 hover:text-green-600">About</Link>
          <Link href="#" className="block py-2 text-gray-700 hover:text-green-600">Contact</Link>
        </div>
      )}
    </header>
  )
