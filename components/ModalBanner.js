      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-2">
            <button type="button" onClick={close} className="px-4 py-2 text-gray-600 hover:text-gray-800">Cancel</button>
            <button type="submit" className="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded">Pay with Crypto</button>
          </div>
        </form>
      </motion.div>
    </motion.div>
